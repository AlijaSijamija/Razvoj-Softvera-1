...
namespace RS1_Ispit_asp.net_core.Migrations
{
    ...
    [Migration("20200826202038_ZakljucanoColumn")]
    partial class ZakljucanoColumn
    {
            ...
            modelBuilder.Entity("RS1_Ispit_asp.net_core.EntityModels.Takmicenje", b =>
                {
                    ...
                    b.HasOne("RS1_Ispit_asp.net_core.EntityModels.Skola", "SkolaDomacin")
                        .WithMany()
                        .HasForeignKey("SkolaDomacinID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
