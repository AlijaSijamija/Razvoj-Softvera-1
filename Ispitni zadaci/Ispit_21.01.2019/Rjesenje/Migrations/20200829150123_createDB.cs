        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PredmetIDId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "MaturskiIspitUcesnik",
                columns: table => new
                {
                    MaturskiIspitUcesnikID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ...
                    Uslov = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaturskiIspitUcesnik", x => x.MaturskiIspitUcesnikID);
                    table.ForeignKey(
                        name: "FK_MaturskiIspitUcesnik_MaturskiIspit_MaturskiIspitID",
                        column: x => x.MaturskiIspitID,
                        principalTable: "MaturskiIspit",
                        principalColumn: "MaturskiIspitID",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_MaturskiIspitUcesnik_OdjeljenjeStavka_OdjeljenjeStavkaID",
                        column: x => x.OdjeljenjeStavkaID,
                        principalTable: "OdjeljenjeStavka",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaturskiIspitUcesnik_MaturskiIspitID",
                table: "MaturskiIspitUcesnik",
                column: "MaturskiIspitID");

            migrationBuilder.CreateIndex(
                name: "IX_MaturskiIspitUcesnik_OdjeljenjeStavkaID",
                table: "MaturskiIspitUcesnik",
                column: "OdjeljenjeStavkaID");
